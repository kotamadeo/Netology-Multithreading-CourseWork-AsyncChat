package com.gmail.at.kotamadeo.database;
...
public class SQLService {
    ...
    private static final String URL_CONNECTION_DATABASE = "jdbc:sqlite:src/main/java/com/gmail/at/kotamadeo/database/usersDatabase.db";
    private static final String DRIVER = "org.sqlite.JDBC";
    private static volatile SQLService instance;
